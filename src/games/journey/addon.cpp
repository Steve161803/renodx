...
renodx::utils::settings::Settings settings = {
    ...
    new renodx::utils::settings::Setting{
        ...
        .binding = &shader_injection.barrel_distortion,
        .value_type = renodx::utils::settings::SettingValueType::INTEGER,
        .default_value = 1.f,
    ...
    new renodx::utils::settings::Setting{
        ...
        .label = std::string("- FXAA must be enabled."),
        .section = "About",
    },         
};
...
void OnPresetOff() {
   ...
   renodx::utils::settings::UpdateSetting("FxDithering", 50.f);
...
extern "C" __declspec(dllexport) constexpr const char* DESCRIPTION = "RenoDX Journey";
