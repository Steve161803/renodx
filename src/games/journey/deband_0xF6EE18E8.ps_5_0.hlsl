  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  float3 output_color = renodx::color::srgb::DecodeSafe(o0.rgb);
  float3 film_grain = FilmGrain(output_color, v1.xy);
  o0.rgb = renodx::draw::RenderIntermediatePass(film_grain);
  return;
}
