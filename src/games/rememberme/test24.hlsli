...
// Parameters: x = source-direction restore fraction at full hue_restore. The
// global hue_restore slider scales the final normalized
// lerp(compressed_direction, source_direction, x).
...
float3 psychotm_test24(float3 bt709_linear_input, float peak_value = 1000.f / 203.f,
                       ...
                       float hue_restore = 1.f,  // authored MB hue-restore strength
