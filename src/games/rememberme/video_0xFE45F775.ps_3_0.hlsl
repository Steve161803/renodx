...
float4 main(float2 texcoord : TEXCOORD) : COLOR
{
	...
	r0.xy = float4(0.00156250002, 0.00277777785, 0, 0).xy;
	r0.xy = r0.xy * DNEBlur.x;
	r1.xyz = 0;
	r2.x = 0;
	for (int i0 = 0; i0 < 5; i0++) {
		r2.xw = (r2.x + float4(1, 1, 0.0399999991, -2)).xw;
		r3.xyz = r1.xyz;
		r3.w = 0;
		for (int i1 = 0; i1 < 5; i1++) {
			r2.yz = (r3.w + float4(-2, -2, 1, 0.166666672)).yz;
			r0.zw = (r2.xyyw * r0.xyxy + texcoord.xyxy).zw;
