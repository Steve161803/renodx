...
renodx::utils::settings::Settings settings = {
    ...
    new renodx::utils::settings::Setting{
        .key = "CellShading",
        .binding = &shader_injection.cell_shading,
        .value_type = renodx::utils::settings::SettingValueType::INTEGER,
        .default_value = 1.f,
        .label = "Cell Shading",
        .section = "Effects",
    ...
    new renodx::utils::settings::Setting{
        ...
        .label = std::string("- Use In-game, Engine.ini, or Driver to limit FPS."
...
void OnPresetOff() {
   ...
   renodx::utils::settings::UpdateSetting("CellShading", 1.f);   
}
...
extern "C" __declspec(dllexport) constexpr const char* DESCRIPTION = "RenoDX Borderlands 2";
